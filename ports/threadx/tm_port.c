...
/* Thread-Metric Component -- Porting Layer (ThreadX) */
...
int tm_queue_create(int queue_id)
{
     ...
     */
    status =
        tx_queue_create(&tm_queue_array[queue_id], "Thread-Metric test",
...
int tm_queue_receive(int queue_id, unsigned long *message_ptr)
{
    ...
    status =
        tx_queue_receive(&tm_queue_array[queue_id], message_ptr, TX_NO_WAIT);
